...
using static PDF2excelConsole.ClassTaboo;

namespace PDF2excelConsole
{
    internal class ClasszhuiotManager1
    {
        public ClassFilesHandleClosedXML filesHandle;

        public List<ClassTaboo> allTaboo;
        List<string> zhuiotCSVfile;
        ClassClosedXML excelOperations;

        public ClasszhuiotManager1(ClassFilesHandleClosedXML fhd, ClassClosedXML excel)
        {
            filesHandle = fhd;
        ...
        public void CreateMortGageTables()
        {
            ...
            excelOperations.createSheet(ClassClosedXML.Sheets.Mortgage, "ז-משכנתאות", Color.Blue);
            excelOperations.setActiveSheet(ClassClosedXML.Sheets.Mortgage);
            ...
            foreach (ClassTaboo taboo in allTaboo)
            {
                ...
                owners = currentrow;
                remarks = currentrow;
                excelOperations.PutValueInSheetRowColumn(ClassClosedXML.Sheets.Mortgage, currentrow, 1, taboo.header.gush);
                excelOperations.PutValueInSheetRowColumn(ClassClosedXML.Sheets.Mortgage, currentrow, 2, taboo.header.helka);
                excelOperations.PutValueInSheetRowColumn(ClassClosedXML.Sheets.Mortgage, currentrow, 18, taboo.PDFFileName);
                foreach (Mortgage mrt in taboo.mortgages)
                {
                    excelOperations.PutValueInSheetRowColumn(ClassClosedXML.Sheets.Mortgage, currentrow, 3, mrt.shtarNum);
                    excelOperations.PutValueInSheetRowColumn(ClassClosedXML.Sheets.Mortgage, currentrow, 4, mrt.date);
                    excelOperations.PutValueInSheetRowColumn(ClassClosedXML.Sheets.Mortgage, currentrow, 5, mrt.MortgageType);
...
//                    excelOperations.PutValueInSheetRowColumn(ClassClosedXML.Sheets.Mortgage, currentrow, 16, ClassUtils.convertPartToPercent(mrt.propPart));
                    ...
                    {
                        excelOperations.PutValueInSheetRowColumn(ClassClosedXML.Sheets.Mortgage, remarks, 17, mrt.remarks[i]);
                        remarks++;
                    }
                    ...
                    try
                    {
                        excelOperations.CorrectFormatForSum(ClassClosedXML.Sheets.Mortgage, 16, startrow, currentrow - 1, "0.00000%");
                    }
                    catch (Exception e)
                    {
                ...
                excelOperations.setBoarder(ClassClosedXML.Sheets.Mortgage, startrow, currentrow - 1, 1, 17, 2);
                excelOperations.addNameRange(ClassClosedXML.Sheets.Mortgage, startrow, currentrow - 1, 1, 17, Convert.ToInt32(taboo.header.gush), Convert.ToInt32(taboo.header.helka), 0, "ZM");

                //    int endrow;
                //    endrow = Math.Max(section, currentrow);
                //    endrow = Math.Max(owners, currentrow);
                //    excelOperations.setBoarder(ClassClosedXML.Sheets.Mortgage, startrow, endrow - 1, 1, 13, 1);
                //    currentrow = endrow;
                //    startrow = currentrow;
        ...
        {
            if ((allTaboo is null) || allTaboo.Count == 0) return;
            excelOperations.createSheet(ClassClosedXML.Sheets.Remark, "ז-הערות", Color.Blue);
            excelOperations.setActiveSheet(ClassClosedXML.Sheets.Remark);
            excelOperations.refreshAll();
            int currentrow;
            int topBox;
            ...
            foreach (ClassTaboo taboo in allTaboo)
            {
                ...
                excelOperations.PutValueInSheetRowColumn(ClassClosedXML.Sheets.Remark, currentrow, 1, taboo.header.gush);
                excelOperations.PutValueInSheetRowColumn(ClassClosedXML.Sheets.Remark, currentrow, 2, taboo.header.helka);
                excelOperations.PutValueInSheetRowColumn(ClassClosedXML.Sheets.Remark, currentrow, 10, taboo.PDFFileName);
                foreach (Remarks remark in taboo.remarks)
                {
                    excelOperations.PutValueInSheetRowColumn(ClassClosedXML.Sheets.Remark, currentrow, 3, remark.shtarNum);
                    excelOperations.PutValueInSheetRowColumn(ClassClosedXML.Sheets.Remark, currentrow, 4, remark.date);
                    excelOperations.PutValueInSheetRowColumn(ClassClosedXML.Sheets.Remark, currentrow, 5, remark.actionType);
                    sectionrow = currentrow;
                    remarkrows = currentrow;

                    for (int i = 0; i < remark.onOwner.Count; sectionrow++, i++)
                    {
                        excelOperations.PutValueInSheetRowColumn(ClassClosedXML.Sheets.Remark, sectionrow, 6, remark.onOwner[i]);

                        if (remark.idType.Count >= remark.onOwner.Count) excelOperations.PutValueInSheetRowColumn(ClassClosedXML.Sheets.Remark, sectionrow, 7, remark.idType[i]);
                        if (remark.idNumber.Count >= remark.onOwner.Count) excelOperations.PutValueInSheetRowColumn(ClassClosedXML.Sheets.Remark, sectionrow, 8, remark.idNumber[i]);
                    }
                    for (int i = 0; i < remark.remarks.Count; remarkrows++, i++)
                    {
                        excelOperations.PutValueInSheetRowColumn(ClassClosedXML.Sheets.Remark, remarkrows, 9, remark.remarks[i]);
                    }
                    excelOperations.refreshAll();
        ...
        {
            if ((allTaboo is null) || allTaboo.Count == 0) return;
            excelOperations.createSheet(ClassClosedXML.Sheets.Leasing, "ז-חכירות", Color.Blue);
            excelOperations.setActiveSheet(ClassClosedXML.Sheets.Leasing);
            excelOperations.refreshAll();
            int currentrow;
            ...
            foreach (ClassTaboo taboo in allTaboo)
            {
                ...
                int sectionrow = currentrow;
                int remarkrows = currentrow;
                excelOperations.PutValueInSheetRowColumn(ClassClosedXML.Sheets.Leasing, currentrow, 1, taboo.header.gush);
                excelOperations.PutValueInSheetRowColumn(ClassClosedXML.Sheets.Leasing, currentrow, 2, taboo.header.helka);
                excelOperations.PutValueInSheetRowColumn(ClassClosedXML.Sheets.Leasing, currentrow, 15, taboo.PDFFileName);
                foreach (Leasing leas in taboo.leasings)
                {
                    excelOperations.PutValueInSheetRowColumn(ClassClosedXML.Sheets.Leasing, leasinRow, 10, leas.LeaserLevel);
                    excelOperations.PutValueInSheetRowColumn(ClassClosedXML.Sheets.Leasing, leasinRow, 11, leas.OriginlShtar);
                    excelOperations.PutValueInSheetRowColumn(ClassClosedXML.Sheets.Leasing, leasinRow, 12, leas.EndDate);
                    excelOperations.PutValueInSheetRowColumn(ClassClosedXML.Sheets.Leasing, leasinRow, 13, leas.PropertyPart);

                    foreach (LeasingOwner own in leas.leasingOwners)
                    {
                        excelOperations.PutValueInSheetRowColumn(ClassClosedXML.Sheets.Leasing, sectionrow, 3, own.shtarNum);
                        excelOperations.PutValueInSheetRowColumn(ClassClosedXML.Sheets.Leasing, sectionrow, 4, own.date);
...
//                        excelOperations.PutValueInSheetRowColumn(ClassClosedXML.Sheets.Leasing, sectionrow, 9, own.LeaserPart);
                    ...
                    {
                        excelOperations.PutValueInSheetRowColumn(ClassClosedXML.Sheets.Leasing, remarkrows, 14, ss);
                        remarkrows++;
                    }
                    excelOperations.refreshAll();
                    //                   
                ...
                excelOperations.setBoarder(ClassClosedXML.Sheets.Leasing, currentrow, endrow - 1, 1, 15, 1);
                excelOperations.addNameRange(ClassClosedXML.Sheets.Leasing, currentrow, endrow - 1, 1, 15, Convert.ToInt32(taboo.header.gush), Convert.ToInt32(taboo.header.helka), 0, "ZL");
        ...
        {
            if ((allTaboo is null) || allTaboo.Count == 0) return;
            excelOperations.createSheet(ClassClosedXML.Sheets.Property, "ז-תאור הנכס", Color.Blue);
            excelOperations.setActiveSheet(ClassClosedXML.Sheets.Property);
            int currentrow;
            int serialNum = 1;
            currentrow = excelOperations.BuildPropertyHeader();
            foreach (ClassTaboo taboo in allTaboo)
            {
                excelOperations.PutValueInSheetRowColumn(ClassClosedXML.Sheets.Property, currentrow, 1, serialNum.ToString());
                ...
                excelOperations.PutValueInSheetRowColumn(ClassClosedXML.Sheets.Property, currentrow, 9, taboo.PDFFileName);
                currentrow++;
                serialNum++;
            }
            excelOperations.setSheetCellWrapText(ClassClosedXML.Sheets.Property, false, 9, currentrow, 2);
        }
        public void CreateOwnersTable()
        {
            if ((allTaboo is null) || allTaboo.Count == 0) return;

            excelOperations.createSheet(ClassClosedXML.Sheets.Owner, "ז-בעלים", Color.Blue);
            excelOperations.setActiveSheet(ClassClosedXML.Sheets.Owner);
            excelOperations.refreshAll();
            int currentrow;
            int topBox = 0;
            int serialNum = 1;
            ...
            foreach (ClassTaboo taboo in allTaboo)
            {
                ...
                bool RemfirstX = true;
                beginFrame = currentrow;
                excelOperations.PutValueInSheetRowColumn(ClassClosedXML.Sheets.Owner, currentrow, 2, taboo.header.gush);
                excelOperations.PutValueInSheetRowColumn(ClassClosedXML.Sheets.Owner, currentrow, 3, taboo.header.helka);
                excelOperations.PutValueInSheetRowColumn(ClassClosedXML.Sheets.Owner, currentrow, 15, taboo.PDFFileName);
                foreach (ClassTaboo.ZhuiotOwner own in taboo.zhuiotOwners)
                {
                    excelOperations.PutValueInSheetRowColumn(ClassClosedXML.Sheets.Owner, currentrow, 1, serialNum.ToString());
                    excelOperations.PutValueInSheetRowColumn(ClassClosedXML.Sheets.Owner, currentrow, 4, own.shtarNum);
                    excelOperations.PutValueInSheetRowColumn(ClassClosedXML.Sheets.Owner, currentrow, 5, own.date);
                    ...
                    if (taboo.mortgages != null && MortfirstX)
                    {
                        ...
                        excelOperations.createHyperLink(ClassClosedXML.Sheets.Owner, currentrow, 12, taboo.header.gush, taboo.header.helka, "0", "ZM");
                        MortfirstX = false;
                    }
                    if (taboo.leasings != null && LeasfirstX)
                    {
                        excelOperations.PutValueInSheetRowColumn(ClassClosedXML.Sheets.Owner, currentrow, 13, "X");
                        excelOperations.createHyperLink(ClassClosedXML.Sheets.Owner, currentrow, 13, taboo.header.gush, taboo.header.helka, "0", "ZL");
                        LeasfirstX = false;
                    }
                    if (taboo.remarks != null && RemfirstX)
                    {
                        excelOperations.PutValueInSheetRowColumn(ClassClosedXML.Sheets.Owner, currentrow, 14, "X");
                        excelOperations.createHyperLink(ClassClosedXML.Sheets.Owner, currentrow, 14, taboo.header.gush, taboo.header.helka, "0", "ZR");
                        RemfirstX = false;
                    }
                ...
                excelOperations.setBoarder(ClassClosedXML.Sheets.Owner, beginFrame, currentrow - 1, 1, 14, 1);
                excelOperations.refreshAll();
                excelOperations.CorrectFormatForSum(ClassClosedXML.Sheets.Owner, 11, beginFrame, currentrow - 1, "0.00000%");
            }
            excelOperations.setSheetCellWrapText(ClassClosedXML.Sheets.Owner, false, 14, currentrow, 2);
